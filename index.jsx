...
export default function Home() { 
 ...
 // Fetch real tasks from your backend 
 useEffect(() => { 
    ...
    <div className="min-h-screen bg-white text-gray-800 font-sans"> 
      ...
      <header style={{ backgroundColor: '#007A5A' }} className="text-white p-4 flex justify-between items-center shadow-md">
        ...
        <span className="relative"> 
          <span className="absolute -top-2 -right-1 text-yellow-300 text-xs">&#9873;</span> 
      ...
      {/* Jara Mode Banner */}
      <div onClick={() => setIsJaraMode(!isJaraMode)} 
      ...
      <main className="p-4">
        ...
        <div className="mb-6 text-center"> 
          <h2 className="text-lg font-semibold mb-1 text-gray-600">₦Earned Today</h2>
          <div className="inline-block bg-gradient-to-r from-green-400 to-teal-500 text-white text-3xl md:text-4xl font-extrabold py-3 px-6 rounded-full shadow-lg animate-pulse"> 
      ...
      <div className="space-y-4"> 
        ...
        <div className="grid grid-cols-1 gap-4"> 
          ...
          <div key={task.id} 
            ...
            <button className="mt-3 w-full bg-green-600 hover:bg-green-700 text-white py-2 rounded-md text-sm font-medium transition">
              Start Task 
            </button> 
          </div> 
        ))} 
